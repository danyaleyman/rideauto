...
## Следующий блок дорожной карты

После закрепления «одной правды» логично перейти к **блоку A / полный объём метрик** (не только выборка по LIMIT в топ-секциях аудита, а сводка по **всем** строкам Encar в `cars`) — см. обсуждение зрелости в команде.
