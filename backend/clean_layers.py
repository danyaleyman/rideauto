...
def build_clean_layers(data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "spec_clean": {
            ...
            "power_hp": _safe_str(data.get("power_hp") or data.get("power")),
            "power_ice_hp": _safe_str(data.get("power_ice_hp")),
            "power_electric_hp": _safe_str(data.get("power_electric_hp")),
            "hybrid_layout": _safe_str(data.get("hybrid_layout")),
