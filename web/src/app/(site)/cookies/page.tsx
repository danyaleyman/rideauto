      ...
      <main className="doc-wrap">
        <article className="doc-card">
          ...
          <ul>
            ...
            <li>
              <strong>Аналитические и маркетинговые скрипты</strong> (счётчики Яндекс.Метрики,
              Top.Mail.Ru; при настройке — пиксель VK Реклама) подключаются только после выбора
              «Принять» в баннере cookie.
            </li>
          </ul>
