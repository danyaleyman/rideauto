...
/** Общие стили юр. страниц (как frontend/privacy.html). */
  ...
  return (
    <>
      ...
      <style>{`
        ...
        .doc-card { background: var(--wra-surface); border: 1px solid var(--wra-border); border-radius: 16px; padding: clamp(20px, 4vw, 28px); box-shadow: var(--shadow-sm); }
        ...
        .doc-legal-page .doc-card a:hover { color: var(--wra-primary-hover); }
        .legal-page { max-width: 980px; margin: 24px auto; background: var(--wra-surface); border: 1px solid var(--wra-border); border-radius: 16px; padding: clamp(20px, 4vw, 28px); box-shadow: var(--shadow-sm); }
        ...
        .legal-page a:hover { color: var(--wra-primary-hover); }
      `}</style>
